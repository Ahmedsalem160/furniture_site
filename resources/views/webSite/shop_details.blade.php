...
<div class="shop-detail-box-main">
    <div class="container">
        <div class="row">
                ...
                <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        @foreach($productsAllImage as $key => $img)
                         <div class="carousel-item {{$key==0?'active':''}} "> <img class="d-block w-100" src="{{$img->image}}" alt="First slide"> </div>
                        @endforeach
                    </div>
                    ...
                    <ol class="carousel-indicators">
                        ...
                        <li data-target="#carousel-example-1" data-slide-to="{{$key}}" class="{{$key==0?'active':''}}">
                            <img class="d-block w-100 img-fluid" src="{{$img->image}}" alt="" />
                        </li>
                        @endforeach
            ...
            <form method="POST" action="{{route('Add.orders',$products->id)}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="single-product-details">
                    ...
                    <p>  {{$products ->description}}</p>
                            ...
                            <div class="form-group quantity-box ">
                                ...
                                <input class="form-control text-lg-center" value="1" min="0" max="20" name="products[{{$products->id}}][quantity]" type="number">
                            </div>
