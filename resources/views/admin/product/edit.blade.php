...
@section('content')
    ...
    @include('admin.includes.breadcrumb',['var'=>'Edit-Product','link'=>'
    <form action="{{route(\'product-show\',[$product->subCategory_id])}}" method="GET">
        <input type="submit" class="btn btn-success" value="All products"/>
    </form>
'])
    <!-- row -->
