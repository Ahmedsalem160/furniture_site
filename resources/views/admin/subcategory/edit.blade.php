        ...
        <div class="col-lg-8 col-xl-8 col-md-12 col-sm-12">
            <div class="card  box-shadow-0">
                ...
                <div class="card-body pt-0">
                    <form class="form-horizontal" enctype="multipart/form-data" action="{{route('sub-category-update',[$subCategory->id])}}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="inputEmail3" name="description" value="{{$subCategory->description}}">
                        </div>
